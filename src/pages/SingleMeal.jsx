...
if (isLoading) {
  ...
  return (
    <div className='container mt-2 '>
      <div>
        <img src={meal.strMealThumb} alt= {meal.strMeal} className='w-100' style={{height: '400px', objectFit: 'cover'}}/>
        <div className='mt-3'>
          <p>
          ...
          <div className='mt-2'>
            <ReactPlayer url={meal.strYoutube} controls={'true'} width={'100%'} height={'450px'} playing={'true'} />
          </div>
        </div>
      </div>
    </div>
